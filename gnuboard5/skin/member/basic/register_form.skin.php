        ...
        <ul class="wow_info">
            ...
            <label for="reg_mb_1" class=""><strong>진영</strong></label>
                <ul class="camp">
                    <li>
                    <label>
                        <input required type="radio" name="mb_1" value="A" <?php echo get_text($member['mb_1']) == 'A' ? 'checked' : '' ?>>
                    ...
                    <li>
                        ...
                        <label>
                            <input required type="radio" name="mb_1" value="H" <?php echo get_text($member['mb_1']) == 'H' ? 'checked' : '' ?>>
